...
Before we move on, it's good to get in the habit of initialising a Repository on GitHub for new projects.

Navigate to the Source Control tab on the left hand side of VS Code

You can also push `ctrl + shift + g`

<br/>

<Image src="/first_commit.png" alt="Screenshot of the first_commit" width={400} height={400} />

### Authorise GitHub

You'll now need to authorise git / github to work together. Follow the pop ups as required.

### Public or Private Repository?

You can publish your work to a public Repository, as a way to show off your progress during this course!

<br/>

<Image src="/publish_public.png" alt="Screenshot of the publish choices" width={1000} height={400} />
